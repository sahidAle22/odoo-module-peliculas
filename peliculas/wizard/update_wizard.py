...
class UpdateWizard(models.TransientModel):
    ...
    def update_vista_general(self):
        presupuesto_obj = self.env['presupuesto'] # Apuntar al modelo presupuesto
        # presupuesto_id = presupuesto_obj.search([('id','=',self._context['active_id'])]) # Buscar un registro en especifico
